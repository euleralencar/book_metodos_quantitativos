...
\$\mu = E(X) = \sum\*{i=1}\^{n} x_i f(x_i) =\* \sum{i=1}\^{n} x_i P(X=x_i) = 0 \left(\frac{1}{4}\right) + 1 \left(\frac{1}{2}\right) + 2 \left(\frac{1}{4}\right) = 1 \$
...
\$ Cov(Y_t,Y\_{t-2}) = Cov(4-2\epsilon\*t, 4-2\epsilon{t-2}) = 4Cov(\epsilon\*t,\epsilon{t-2}) = 0\$
